...
public class VCollection<A, B> with [VCollection A.myfield] {
	public List<A> col = new ArrayList<A>();
	B owner;
	VCollection(B owner) {
		this.owner = owner;
	}
	...
	public void add(A a) {
		this.col.add(a);
		a.myfield.col.add(owner);  //this is not infinite loop
	}
}
...
public class People {
	...
	public final VCollection<Class, People> classes = new VCollection<Class, People> with [Class.students] (this);  //~ inverse ac;
}
...
public class Class {
	...
	public final VCollection<People, Class> students = new VCollection<People, Class> with [People.classes] (this);	//~ inverse bc
}
